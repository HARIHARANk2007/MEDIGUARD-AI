...
const html = `
<body class="bg-background text-on-background font-body-md antialiased md:hidden overflow-x-hidden">
<!-- TopAppBar -->
...
<button class="w-full sm:w-auto px-6 py-4 bg-primary text-on-primary font-label-md text-label-md rounded-xl flex items-center justify-center gap-2 hover:bg-primary-fixed-variant transition-colors active:opacity-80">
<span class="material-symbols-outlined">troubleshoot</span>
                        Check Drug Interaction
                    </button>
<button class="w-full sm:w-auto px-6 py-4 bg-surface border border-outline text-on-surface font-label-md text-label-md rounded-xl flex items-center justify-center gap-2 hover:bg-surface-container-low transition-colors active:opacity-80">
